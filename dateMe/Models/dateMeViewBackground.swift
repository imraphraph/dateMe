...
class dateMeViewBackground: UIView, DraggableViewDelegate {
...
//        
        ...
        xButton.setImage(UIImage(named:"no")!,for: .normal)
        ...
        checkButton.setImage(UIImage(named:"yes")!,for: .normal)
